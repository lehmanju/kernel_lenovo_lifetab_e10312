...
#define ACC_IDEVICE_NAME		"gsensor"
#define STKDIR				0x3D
...
#define STK_IOCTL_INIT                  _IO(STKIO, 0x01)
#define STK_IOCTL_RESET      	          _IO(STKIO, 0x04)
#define STK_IOCTL_CLOSE		           _IO(STKIO, 0x02)
#define STK_IOCTL_START		             _IO(STKIO, 0x03)
