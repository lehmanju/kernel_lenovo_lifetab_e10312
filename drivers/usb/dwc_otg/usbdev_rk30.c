...
#define RK3066B_HOST_DRV_VBUS   RK30_PIN1_PD2
#define RK3066B_OTG_DRV_VBUS    RK30_PIN1_PD7
#define RK3066B_OTG_VBUS_CHARGE RK30_PIN2_PC3
#endif
...
#if defined(CONFIG_ARCH_RK3066B) || defined(CONFIG_ARCH_RK3188) || defined(CONFIG_ARCH_RK30XX)
        //GPIO init
        gpio_request(RK3066B_OTG_DRV_VBUS, NULL);
        gpio_direction_output(RK3066B_OTG_DRV_VBUS, GPIO_LOW);
        gpio_request(RK3066B_OTG_VBUS_CHARGE, NULL);
        gpio_direction_output(RK3066B_OTG_VBUS_CHARGE, GPIO_LOW);
#else
...
{ 
    ...
    if(0 == enable)//disable
    {
        ...
        gpio_set_value(RK3066B_OTG_VBUS_CHARGE, GPIO_LOW); 

    }
    if(1 == enable)//enable
    {
        gpio_set_value(RK3066B_OTG_DRV_VBUS, GPIO_HIGH); 
        gpio_set_value(RK3066B_OTG_VBUS_CHARGE, GPIO_HIGH); 
    }   
}
#endif
